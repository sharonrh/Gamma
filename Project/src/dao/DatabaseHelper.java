...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public boolean insertProfil(String nama, String tinggi, String berat, String jenisKelamin,
			int vegetarian, int alergiTelur, int alergiMakananLaut, int alergiKacang) {
		ContentValues cv=new ContentValues();
	...
	public ArrayList<Laporan> getDataLaporan() {
	    ...
	    for(c.moveToFirst(); !c.isAfterLast();c.moveToNext()){
	    	Laporan l = new Laporan(c.getString(iBerat) ,c.getString(iTinggi));	
	    	result.add(l);
	    }
	    return result;
	}
	...
	public ArrayList<String> getDataProfil() {
	    // TODO Auto-generated method stub
	    String[]columns=new String[]{"nama", "tinggi", "berat", "jenisKelamin", "vegetarian", "alergiTelur", "alergiMakananLaut", "alergiKacang"};
	    
	    Cursor c =getReadableDatabase().query("profil", columns, null, null, null, null, null);
	    ...
	    System.out.println("i " + iBerat);
	    for(c.moveToFirst(); !c.isAfterLast();c.moveToNext()){
	    	result.add(c.getString(iNama) + "," + c.getString(iTinggi)+ "," + c.getString(iBerat)+ "," + c.getString(iJenisKelamin)
	    			+ "," + c.getString(iVegetarian)+ "," + c.getString(iAlergiTelur)+ "," + c.getString(iAlergiMakananLaut)+ "," + c.getString(iAlergiKacang));
	    }
	    return result;
	}
